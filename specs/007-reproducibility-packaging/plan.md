...
1. Kiểm kê artifact Phase 1–10, phân loại tệp Git/ngoài Git và ghi rõ Model C là app checkpoint,
   Model B là rollback/historical Phase 5 winner, Phase 9 là benchmark hậu kiểm.
...
6. Chạy clean-room local setup cho inference/web và diễn tập demo offline.

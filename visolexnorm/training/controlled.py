...
def run_controlled_training(args: Any, *, optimization: bool = False) -> None:
    ...
    if args.smoke_test:
        ...
        terminal = {"selected_dev_loss": history[-1]["dev_loss"], "selected_epoch": history[-1]["epoch"], "selection_metric": "terminal_epoch", "selected_checkpoint_kind": "terminal_at_stop"}
        write_model_predictions(model, run_root / "terminal_dev_predictions.jsonl", terminal, metrics_name="terminal_dev_metrics.json")
